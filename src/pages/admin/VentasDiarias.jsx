...
const VentasDiarias = () => {
  ...
  const fetchVentas = async (date) => {
    ...
    try {
      ...
      console.log(`[FRONT] Ventas diarias cargadas para ${date}`);
    } catch (err) {
      console.error(err);
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          ...
          <div className="bg-[#23232b] p-4 rounded-xl shadow text-center border border-[#D4AF37]/20">
            ...
            <div className="text-lg font-bold text-[#D4AF37]">
              {ventas.totalVendido.toLocaleString("es-CO", {
                style: "currency",
                currency: "COP",
              })}
            </div>
